...
LOG_DIR="$REPO_ROOT/.claude_code_runs/ui_ux_round19"
...
echo "${BOLD}Plan:${NC} ${#PROMPTS[@]} UI UX Round 19 prompts total (${SELECTED} selected)"
...
echo
echo "${GREEN}${BOLD}All selected UI UX Round 19 prompts complete.${NC}"
