 ...
 *
 * Routed at `/principles/[id]/triage`. The canonical `/principles/[id]`
 * URL is the public Round-21 detail page; this sub-route is the
 * authed-only acceptance form. Server-action redirects below send the
 * founder back to the queue after acting, and the queue's row links
 * deep-link here for the next pass.
 *
