...
- **Timestamp (UTC):** 20260516T164544Z
- **Branch:** main
- **HEAD:** 4a123b1
...
| 3 | End-to-end smoke harness | ❌ FAIL | 7s | 240s | `step3_smoke-harness.log` |
...
Inspect the per-step log:
    ...
    less docs/verification/ready_to_sync/20260516T164544Z/step3_smoke-harness.log
