...
- **Timestamp (UTC):** 20260516T164142Z
- **Branch:** main
- **HEAD:** 4a123b1
...
| 2 | Import cycles + type contracts | ✅ PASS | 4s | 30s | `step2_import-cycles-and-types.log` |
...
Inspect the per-step log:
    ...
    less docs/verification/ready_to_sync/20260516T164142Z/step3_smoke-harness.log
