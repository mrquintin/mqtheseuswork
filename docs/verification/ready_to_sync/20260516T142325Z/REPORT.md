...
- **Timestamp (UTC):** 20260516T142325Z
- **Branch:** main
- **HEAD:** 4a123b1
...
| 2 | Import cycles + type contracts | ✅ PASS (over) | 38s | 30s | `step2_import-cycles-and-types.log` |
| 3 | End-to-end smoke harness | ❌ FAIL | 0s | 240s | `step3_smoke-harness.log` |
...
- Step 2 (import-cycles-and-types): 38s vs budget 30s
...
Inspect the per-step log:
    ...
    less docs/verification/ready_to_sync/20260516T142325Z/step3_smoke-harness.log
