...
- **Timestamp (UTC):** 20260516T143958Z
- **Branch:** main
- **HEAD:** 4a123b1
...
| 2 | Import cycles + type contracts | ✅ PASS | 5s | 30s | `step2_import-cycles-and-types.log` |
| 3 | End-to-end smoke harness | ❌ FAIL | 4s | 240s | `step3_smoke-harness.log` |
...
Inspect the per-step log:
    ...
    less docs/verification/ready_to_sync/20260516T143958Z/step3_smoke-harness.log
