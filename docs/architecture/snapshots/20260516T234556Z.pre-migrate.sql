...
\restrict e2fLJD44Q63pQZ5subTKFsfqiAczTKFveiHj1tnJZYNcNzKreNGUuQhLYCrN4N0
...
CREATE TABLE public."Conclusion" (
    ...
    "principleKind" text,
    "domainOfApplicability" text,
    "quantifiableProxies" text DEFAULT '[]'::text NOT NULL,
    "decisionExamples" text DEFAULT '[]'::text NOT NULL,
    "sourceSpan" text
);
...
CREATE TABLE public."CritiqueSubmission" (
    ...
    "createdAt" timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    "updatedAt" timestamp(3) without time zone NOT NULL,
    "pilotTag" text DEFAULT ''::text NOT NULL,
    "pilotReviewerSlug" text DEFAULT ''::text NOT NULL,
    "hallOfFameConsent" boolean DEFAULT false NOT NULL
);
...
--
-- Name: QuantitativeFormalisation; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public."QuantitativeFormalisation" (
    id text NOT NULL,
    "organizationId" text NOT NULL,
    "principleId" text NOT NULL,
    status text DEFAULT 'DRAFT'::text NOT NULL,
    "nullHypothesis" text DEFAULT ''::text NOT NULL,
    "metricsJson" text DEFAULT '[]'::text NOT NULL,
    "testsJson" text DEFAULT '[]'::text NOT NULL,
    "dataSourcesJson" text DEFAULT '[]'::text NOT NULL,
    "decisionThresholdsJson" text DEFAULT '[]'::text NOT NULL,
    "unformalisableReason" text,
    "drafterModel" text DEFAULT ''::text NOT NULL,
    "drafterNotes" text DEFAULT ''::text NOT NULL,
    "payloadJson" text DEFAULT '{}'::text NOT NULL,
    "reviewedByFounderId" text,
    "reviewedAt" timestamp(3) without time zone,
    "createdAt" timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
--
-- Name: QuantitativeFormalisation QuantitativeFormalisation_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."QuantitativeFormalisation"
    ADD CONSTRAINT "QuantitativeFormalisation_pkey" PRIMARY KEY (id);
...
--
-- Name: Conclusion_organizationId_createdAt_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "Conclusion_organizationId_createdAt_idx" ON public."Conclusion" USING btree ("organizationId", "createdAt" DESC);
...
--
-- Name: Conclusion_principleKind_null_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "Conclusion_principleKind_null_idx" ON public."Conclusion" USING btree ("organizationId") WHERE ("principleKind" IS NULL);
...
--
-- Name: Contradiction_org_status_severity_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "Contradiction_org_status_severity_idx" ON public."Contradiction" USING btree ("organizationId", status, severity DESC);
...
--
-- Name: CritiqueSubmission_organizationId_pilotTag_status_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "CritiqueSubmission_organizationId_pilotTag_status_idx" ON public."CritiqueSubmission" USING btree ("organizationId", "pilotTag", status);
...
--
-- Name: PublishedConclusion_org_kind_publishedAt_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "PublishedConclusion_org_kind_publishedAt_idx" ON public."PublishedConclusion" USING btree ("organizationId", kind, "publishedAt" DESC);


--
-- Name: PublishedConclusion_org_kind_slug_version_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "PublishedConclusion_org_kind_slug_version_idx" ON public."PublishedConclusion" USING btree ("organizationId", kind, slug, version DESC);
...
--
-- Name: QuantitativeFormalisation_organizationId_status_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "QuantitativeFormalisation_organizationId_status_idx" ON public."QuantitativeFormalisation" USING btree ("organizationId", status);


--
-- Name: QuantitativeFormalisation_principleId_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "QuantitativeFormalisation_principleId_idx" ON public."QuantitativeFormalisation" USING btree ("principleId");
...
--
-- Name: Upload_organizationId_createdAt_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "Upload_organizationId_createdAt_idx" ON public."Upload" USING btree ("organizationId", "createdAt" DESC);
...
--
-- Name: Upload_organizationId_publishedAt_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "Upload_organizationId_publishedAt_id_idx" ON public."Upload" USING btree ("organizationId", "publishedAt" DESC, id);
...
--
-- Name: QuantitativeFormalisation QuantitativeFormalisation_organization_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."QuantitativeFormalisation"
    ADD CONSTRAINT "QuantitativeFormalisation_organization_fk" FOREIGN KEY ("organizationId") REFERENCES public."Organization"(id) ON DELETE RESTRICT;


--
-- Name: QuantitativeFormalisation QuantitativeFormalisation_principle_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public."QuantitativeFormalisation"
    ADD CONSTRAINT "QuantitativeFormalisation_principle_fk" FOREIGN KEY ("principleId") REFERENCES public."Principle"(id) ON DELETE CASCADE;
...
\unrestrict e2fLJD44Q63pQZ5subTKFsfqiAczTKFveiHj1tnJZYNcNzKreNGUuQhLYCrN4N0
